...
+ (UIColor *)myColorWithHexString:(NSString *)color alpha:(CGFloat)alpha
{
    //删除字符串中的空格
...
//默认alpha值为1
+ (UIColor *)myColorWithHexString:(NSString *)color
{
    return [self myColorWithHexString:color alpha:1.0f];
}
