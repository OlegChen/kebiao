...
typedef NS_ENUM(NSInteger, EaseBlankPageType)
{
    ...
    WelfareBlankPageTypeView, //福利
    HelperBlankPageTypeView, //学习助手 视频
    MyClassBlankPageTypeView, //我的课程 列表
    ClassImgDetailBlankPageTypeView,  //课程图文详情
    ClassCommentListBlankPageTypeView,  //课程详情 评论
    CartListBlankPageTypeView,  //购物车列表
    MyCollectionNoClassBlankPageTypeView,  //我的收藏 没有课程
    MyCollectionNoKnowledgeBlankPageTypeView,   //我的收藏 没有小知识
    MyChildrenBlankPageTypeView,   //学习成员
    MyOrderBlankPageTypeView,   //订单
    SearchBlankPageTypeView,   //搜索
    AuditonListPageTypeView,   //搜索
};
