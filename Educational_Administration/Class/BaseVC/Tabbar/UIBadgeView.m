...
//    CGSize badgeSize = [badgeValue getSizeWithFont:font constrainedToSize:CGSizeMake(kMaxBadgeWith, 20) w];
    
    CGSize badgeSize =  [self getSizeWithFont:font constrainedToSize:CGSizeMake(kMaxBadgeWith, 20) WithStr:badgeValue];
...
+ (CGSize)getSizeWithFont:(UIFont *)font constrainedToSize:(CGSize)size WithStr:(NSString *)str{
    CGSize resultSize = CGSizeZero;
    if (str.length <= 0) {
        return resultSize;
    }
    resultSize = [str boundingRectWithSize:size
