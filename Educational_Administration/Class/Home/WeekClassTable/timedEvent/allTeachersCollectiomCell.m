...
@interface allTeachersCollectiomCell () <UICollectionViewDataSource ,UICollectionViewDelegate, UICollectionViewDelegateFlowLayout ,MGCTimedEventsViewLayoutDelegate>
...
@implementation allTeachersCollectiomCell
...
//        //--------------------------------
//        _timedEventsView.userInteractionEnabled = NO;
//        
...
//
//
//- (MGCEventView*)dayPlannerView:(allTeachersCollectiomCell *)view viewForEventOfType:(MGCEventType)type atIndex:(NSUInteger)index date:(NSDate*)date
//{
...
//{
//    return CGSizeMake(20, self.bounds.size.height);
//}//eachTeacherEventCellWidth
//
//
//
...
//}
//
//- (void)setDayColumnSize:(CGSize)dayColumnSize{
//    
//    _dayColumnSize = dayColumnSize;
//}
//
